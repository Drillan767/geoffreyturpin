        ...
        <nav class="bg-white border-b border-gray-100">
                ...
                <div class="flex justify-between h-16">
                    <div class="flex">
                        ...
                        <div class="flex-shrink-0 flex items-center">
                            <inertia-link :href="route('user.edit')">
                        ...
                        <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                            <jet-nav-link :href="route('user.edit')" :active="route().current('user.edit')">
                                <i class="fas fa-user mr-2"></i>
                                Profil
                            </jet-nav-link>

                            <jet-nav-link :href="route('music.index')" :active="route().current('music.index')">
                                <i class="fas fa-music mr-2"></i>
                                Musiques
                            </jet-nav-link>

                            <jet-nav-link :href="route('biography.index')" :active="route().current('biography.index')">
                            ...
                            <jet-nav-link
                                ...
                                :active="(['admin.articles.index', 'articles.create', 'articles.edit', 'articles.translate'].includes($page.currentRouteName))"
                            >
                        ...
                        <div class="ml-3 relative">
                            <jet-dropdown align="right" width="48">
                                ...
                                <template #content>
                                    ...
                                    <!-- Authentication -->
                                    <form @submit.prevent="logout" class="dropdown">
            ...
            <div :class="{'block': showingNavigationDropdown, 'hidden': ! showingNavigationDropdown}" class="sm:hidden">
                <div class="pt-2 pb-3 space-y-1">
                    <jet-responsive-nav-link :href="route('user.edit')" :active="route().current('dashboard')">
                        Profil
                ...
                <div class="pt-4 pb-1 border-t border-gray-200">
                    ...
                    <div class="mt-3 space-y-1">
                        <jet-responsive-nav-link :href="route('fr.home')">
                            Retour vers le site
                        </jet-responsive-nav-link>
